document.addEventListener("DOMContentLoaded", function () {
    ...
    function resetAll() {
        ...
        if (btnRekapImage) btnRekapImage.src = "assets/images/home-button.png";
        if (btnProfilImage) btnProfilImage.src = "assets/images/wallet.png";
    ...
    if (btnOpenTableDetail && tableDetail) {
        btnOpenTableDetail.addEventListener("click", function () {
            ...
            if (
                ...
                collapseImage.src = "assets/images/close_collapse.png";
            } else if (collapseImage) {
                collapseImage.src = "assets/images/open_collapse.png";
            }
        });
    }
    ...
    if (btnRekap && tableRekapElement && btnRekapImage) {
        btnRekap.addEventListener("click", function () {
            if (tableRekapElement.classList.contains("hidden")) {
                ...
                btnRekapImage.src = "assets/images/active_home-button.png";
            } else {
                tableRekapElement.classList.add("hidden");
                btnRekapImage.src = "assets/images/home-button.png";
            }
        });
    }
    ...
    if (btnProfil && formProfil) {
        btnProfil.addEventListener("click", function () {
            if (formProfil.classList.contains("hidden")) {
                ...
                btnProfilImage.src = "assets/images/active_wallet.png";
            } else {
                formProfil.classList.add("hidden");
                btnProfilImage.src = "assets/images/wallet.png";
            }
        });
    }
    ...
    if (scrollUpDownForm) {
        ...
        scrollUpDownForm.addEventListener("touchmove", function (event) {
            ...
            const diffYForm =
                ((touchStartYForm - touchCurrentYForm) / window.innerHeight) *
                100;
    ...
    if (formProfil) {
        ...
        formProfil.addEventListener("touchmove", function (event) {
            ...
            const diffYProfil =
                ((touchStartYProfil - touchCurrentYProfil) /
                    window.innerHeight) *
                100;
    ...
    class TableDisplayManager {
        constructor() {
            ...
            this.kembaliTable = document.querySelector(
                ".btn_close_judul_table"
            );
            this.changeHeightRekap = document.querySelector(
                ".change_height_rekap"
            );
        ...
        initialize() {
            ...
            this.judulTable?.addEventListener("click", () =>
                this.expandTable()
            );
            this.kembaliTable?.addEventListener("click", () =>
                this.collapseTable()
            );
        }
        ...
        toggleTableHeight() {
            const isExpanded =
                this.changeHeightRekap.classList.contains("h-[78vh]");
        ...
        updateActiveMenu(selectedIcon) {
            this.menuIcons.forEach((icon) => {
                ...
                icon.src =
                    menuId === "1"
                        ? icon === selectedIcon
                            ? "assets/images/open_active.png"
                            : "assets/images/open_collapse.png"
                        : icon === selectedIcon
                        ? "assets/images/active_home-button.png"
